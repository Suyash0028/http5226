...
using n01629153_EventManagement.Models;

namespace n01629153_EventManagement.Controllers
{
    public class EventsDataController : ApiController
    {
        ...
        public IEnumerable<EventDto> ListEvents()
        {
            ...
            Events.ForEach(a => EventDtos.Add(new EventDto()
            {
                EventId = a.EventId,
                EventName = a.EventName,
                EventDescription = a.EventDescription,
                EventDate = a.EventDate,
                SponsorName = a.Sponsors.SponsorName,
                UserName = a.EventUsers.UserName
